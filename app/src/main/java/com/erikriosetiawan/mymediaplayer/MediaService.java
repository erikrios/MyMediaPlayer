...
public class MediaService extends Service implements MediaPlayerCallback {
    ...
    public final static String ACTION_CREATE = "com.erikriosetiawan.mymediaplayer.mediaservice.create";
    public final static String ACTION_DESTROY = "com.erikriosetiawan.mymediaplayer.mediaservice.destroy";
